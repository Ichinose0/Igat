...
impl Menubar {
    ...
    pub(crate) fn view(&self, window: &Window) -> Vec<acure::Command> {
        ...
        for i in &self.children {
            view.push(acure::Command::FillRectangle(x,i.y,i.width,i.height,2.0,i.background_color.into()));
            view.push(acure::Command::WriteString(x,i.y,i.width,i.height+2,Color::Black.into(),i.text.clone()));
            x = x+i.width+2;
        }
        view
    }
